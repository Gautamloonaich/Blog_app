...
export function Fotter(){
    return (
        ...
        <div >
            ...
            <Link href="/"><Image  src={logo} alt="blogger_logo" height={180} width={180} className=" w-[130px] sm:w-[120px] md:w-[180px] cursor-pointer"/></Link> 
             <p className="text-gray-200 text-[15px] sm:text-lg text-center font-light sm:font-normal">All right reserved.Copyright @blogger</p>
             <div className=" flex ">
