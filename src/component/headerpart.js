    ...
    return(
        ...
        <div className="px-3 md:px-12 lg:px-30 pt-5  ">
           ...
           <div className="flex flex-col justify-center  space-y-5 sm:space-y-10 p-3 mt-5 md:mt-7 items-center">
              ...
              <form onSubmit={handlesumbit}  className=" border flex  items-center justify-center shadow-[_-3px_3px_2px_rgb(0,0,0)] sm:shadow-[_-4px_4px_2px_rgb(0,0,0)]  ">
                     <input onChange={(e)=>setmail(e.target.value)} value={mail} type="email" className="border   outline-0 text-lg sm:text-xl py-1.5 sm:py-3 px-2 sm:px-4 min-w-30 sm:min-w-95 hover:shadow-[_-5px_5px_4px_rgb(0,0,0)] sm:hover:shadow-[_-7px_7px_4px_rgb(0,0,0)] " placeholder="Enter your email"/>
                     <button  type="submit" className="border py-1.5 px-2 sm:py-3 font-medium sm:px-6 text-lg sm:text-xl active:bg-black active:text-white active:border-black">Suscribe</button>
