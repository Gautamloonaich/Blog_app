...
export  function Commanlayout(){
    return(
        <>
            ...
            <div className="w-[35%] sm:w-[28%]   hidden md:flex md:flex-col border h-[100vh]   ">
              <div className="w-full flex  justify-center border-0 border-b-1  px-3 py-3 ">
                ...
                <div className="  h-[100vh] relative" >
                    <div className="  absolute right-0  top-15  w-[90%] lg:w-[80%]">
                    <Link href="/admin/add_new_product"><div className="border shadow-[-4px_4px_2px_rgb(0,0,0)]  hover:shadow-[-7px_7px_4px_rgb(0,0,0)]  flex justify-start  mt-5 items-center p-2 md:p-3 gap-1 md:gap-2  ">
                  ...
                  <Link href="/admin/item_list">  <div className="border shadow-[-4px_4px_2px_rgb(0,0,0)] hover:shadow-[-7px_7px_4px_rgb(0,0,0)] flex justify-start  mt-8 items-center gap-1 md:gap-2     p-2 md:p-3">
                  ...
                  <Link href="/admin/suscriptions"> <div className="border shadow-[-4px_4px_2px_rgb(0,0,0)] hover:shadow-[-7px_7px_4px_rgb(0,0,0)] flex justify-start  mt-8 items-center gap-1 md:gap-2  p-2 md:p-3">
