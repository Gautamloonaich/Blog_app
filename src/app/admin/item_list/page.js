...
export default function Itemlist(){
    ...
    <div className="ml-0 md:ml-55 lg:ml-70 xl:ml-100 ">
         <ul  className="flex items-center justify-between py-6 sm:py-5 px-2 xs:px-5 sm:px-7 w-[100%] sm:w-[100%] ">
            <li className=" hidden md:block sm:text-2xl  md:text-3xl  lg:text-3xl font-bold md:font-medium order:2 md:order:1 pl-8 "> Blog List</li>        
            <Link href="/"><li className="block md:hidden order:1 md:order:2"> <Image src={bloglogo} alt="logo"  height={200} width={200} className="sm:w-[200px] w-[170px]" /></li></Link>
