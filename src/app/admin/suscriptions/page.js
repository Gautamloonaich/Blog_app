...
export default function Suscription_id(){
    return(
        ...
        <ul  className="flex items-center justify-between py-6 sm:py-5 px-2 xs:px-5 sm:px-7  ">
                       <li className=" hidden sm:block sm:text-2xl  md:text-3xl  lg:text-3xl font-bold md:font-medium order-2 md:order-1">Suscrped Mail</li>        
                       ...
                       <li className="order-3 md:order-3"> <Image src={author} height={50} alt="author"width={50} className="w-[30px] md:w-[40px] lg:w-[50px]"/></li>
